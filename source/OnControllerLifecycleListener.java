...
public interface OnControllerLifecycleListener {
	 ...
	 * @param ControllerInterface aController - the controller which view will be attached to the parent view.
	 */
	 ...
	 * @param ControllerInterface aController - the controller which view will be detached to the parent view. 
	 */
	 ...
	 * @param ControllerInterface aController - the controller which view has been attached to the parent view.
	 */
	 ...
	 * @param ControllerInterface aController - the controller which view has been detached to the parent view. 
	 */
